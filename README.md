...
Validation also covers static pages with JavaScript disabled, explicit locale routes, history navigation, header placement, image loading, cursor response and reduced motion. All changes in this branch are for local review, with no production deployment.
