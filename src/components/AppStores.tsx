...
const messages = {
  pt: { downloads: "downloads no Android", checked: "Faixa pública · consultada em" },
  en: { downloads: "Android downloads", checked: "Public range · checked on" },
  es: { downloads: "descargas en Android", checked: "Rango público · consultado el" },
};
  ...
  return (
    <div className="app-stores">
      <div className="app-store-links">
        <a href={stores.android} target="_blank" rel="noopener noreferrer">
        ...
        <a href={stores.ios} target="_blank" rel="noopener noreferrer">
          <span className="sr-only">{name}: </span>
          ...
          <span>iOS{" "}<small>App Store <span aria-hidden="true">↗</span></small></span>
        </a>
      </div>
